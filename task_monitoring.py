...
def monitor_new_slurm_job(job: dict) -> bool:
  ...
  result = add_job_to_monitor_db(slurm_job_id, slurm_job_status, slurm_job_task_metadata)
  return result

def add_job_to_monitor_db(slurm_job_id: int, slurm_job_status: str, slurm_job_task_metadata: dict) -> bool:
  job = {
