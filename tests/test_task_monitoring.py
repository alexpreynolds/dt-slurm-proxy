...
class TestGetSlurmJobMetadataById(unittest.TestCase):
  ...
  def test_get_slurm_job_metadata_success(self, mock_ed25519key, mock_sshclient):
    ...
    expected_keys = ['job_id', 'job_name', 'state', 'user', 'partition', 'time', 'start', 'end', 'elapsed']
    expected_values = ['123', 'abcd1234', 'COMPLETED', 'username', 'partition', 'UNLIMITED', '2025-04-14T08:57:46', '2025-04-14T11:00:44', '02:02:58']
